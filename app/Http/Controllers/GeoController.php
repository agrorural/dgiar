...
class GeoController extends Controller
{
    ...
    public function getDepartamentos()
    {
        ...
        $url = 'http://qa.agrorural.gob.pe/WEBAPI_GEOVICE/api/geo/ListarDepartamentos';
        $data = trim($_GET['deps']);
    ...
    public function getProvincias()
    {
        ...
        $url = 'http://qa.agrorural.gob.pe/WEBAPI_GEOVICE/api/geo/ListarProvincias';
        $data = trim($_GET['deps']);
        $data = stripslashes($data);
        $data = htmlspecialchars($data);
    ...
    public function getDistritos()
    {
        ...
        $url = 'http://qa.agrorural.gob.pe/WEBAPI_GEOVICE/api/geo/ListarDistritos';
        $data = trim($_GET['deps']);
        $data = stripslashes($data);
        $data = htmlspecialchars($data);
        $Departamentos_ids = $data;
    ...
    public function getCP()
    {
        ...
        $url = 'http://qa.agrorural.gob.pe/WEBAPI_GEOVICE/api/geo/ListarCCPP';
        $data = trim($_GET['deps']);
        $data = stripslashes($data);
        $data = htmlspecialchars($data);
        $Departamentos_ids = $data;
